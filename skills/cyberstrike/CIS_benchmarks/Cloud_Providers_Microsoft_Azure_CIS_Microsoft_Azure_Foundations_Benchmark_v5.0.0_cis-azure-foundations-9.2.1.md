...
# Ensure soft delete for blobs on Azure Blob Storage storage accounts is Enabled
...
Soft delete for blobs should be enabled with `"enabled": true` and `days` set to an appropriate retention period.
