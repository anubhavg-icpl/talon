...
# CIS Ubuntu Linux 18.04 LTS Benchmark v2.2.0 - Control 3.4.3.2.3
...
The output should show rules matching site policy for outbound and established connections.
