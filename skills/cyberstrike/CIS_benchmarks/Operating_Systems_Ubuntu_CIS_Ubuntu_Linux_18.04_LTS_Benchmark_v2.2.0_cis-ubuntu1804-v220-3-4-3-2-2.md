...
# CIS Ubuntu Linux 18.04 LTS Benchmark v2.2.0 - Control 3.4.3.2.2
...
The INPUT chain should accept all traffic on the loopback interface and drop all traffic from 127.0.0.0/8. The OUTPUT chain should accept all traffic going out the loopback interface.
