...
# CIS Ubuntu Linux 18.04 LTS Benchmark v2.2.0 - Control 3.4.2.6
...
The loopback interface should accept traffic, and traffic from 127.0.0.0/8 (and ::1 for IPv6) should be dropped.
