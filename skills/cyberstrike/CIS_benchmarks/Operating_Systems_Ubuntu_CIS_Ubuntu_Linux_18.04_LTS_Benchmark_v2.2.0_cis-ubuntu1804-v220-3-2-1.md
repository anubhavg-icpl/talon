...
#!/usr/bin/bash
{
  ...
  # Check if module is currently loadable
...
- Audit Result:
 ** PASS **
 - module: "dccp" is not loadable: "install /bin/true"
 - module: "dccp" is not loaded
 - module: "dccp" is deny listed in: "/etc/modprobe.d/<filename>.conf"
```
...
dccp module is available by default.
