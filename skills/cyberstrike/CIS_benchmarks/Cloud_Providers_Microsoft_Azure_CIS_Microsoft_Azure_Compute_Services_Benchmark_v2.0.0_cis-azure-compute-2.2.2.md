...
Take note of the currently supported versions (given a status of "security") of Python here:
...
The Python version configured for the deployment slot should be a currently supported release as listed on the Python Developer's Guide versions page with a status of "security" or higher.
