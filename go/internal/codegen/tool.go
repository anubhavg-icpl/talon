...
// CustomExploitTool implements agent.CodegenTool (structurally -- this
// package intentionally does not import internal/agent to avoid an import
// cycle; callers in cmd/api and cmd/worker wire the concrete type in).
