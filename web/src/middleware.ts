...
export const config = {
  ...
  matcher: [
    '/((?!login|api/talon/auth/login|_next/static|_next/image|favicon\\.webp|globe/|wallpaper/|showcase/|agents/|playbooks/|assist/|.*\\.(?:webp|svg|png|jpe?g|gif|ico|mp4|webm|woff2?|ttf|map)$).*)'
  ]
}
